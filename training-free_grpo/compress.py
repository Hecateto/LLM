...
if __name__ == '__main__':
    ...
    print("Loading experiences...:", experiences)
    ...
    for exp in update_experiences:
        if exp['option'] == 'merge':
            ...
            max_id = max_id+1
    # 重新编号
    compress_experiences = {str(idx+1): exp for idx, exp in enumerate(experiences.values())}
    print("Compressed experiences...:", compress_experiences)
    with open('compress_experiences.json', 'w', encoding='utf-8') as f:
        json.dump(compress_experiences, f, ensure_ascii=False, indent=4)